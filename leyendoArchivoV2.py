...
def parse_string(input_string):
    ...
    while stack:
        ...
        if top == current_token:
            ...
            if not production:
                return f"Cadena no aceptada: carácter inesperado '{current_token}' en posición {index+1}"
    ...
    if index < len(input_tokens) - 1:
        return f"Cadena no aceptada: carácter inesperado '{input_tokens[index]}' en posición {index+1}"
